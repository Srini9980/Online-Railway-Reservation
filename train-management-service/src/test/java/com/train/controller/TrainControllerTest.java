...
public class TrainControllerTest {
	...
	public void testAddTrain() throws Exception {
		...
		mockMvc.perform(post("/train/add").contentType(MediaType.APPLICATION_JSON).content(asJsonString(train)))
	...
	public void testGetAllTrain() throws Exception {
		...
		mockMvc.perform(get("/train/all").contentType(MediaType.APPLICATION_JSON).content(asJsonString(trains)))
				.andDo(print());
	...
	public void testGetTrainByFare() throws Exception {
		...
		mockMvc.perform(
				get("/train/fare/10").contentType(MediaType.APPLICATION_JSON).content(asJsonString(responseTemplate)))
				.andDo(print());
	...
	public void testGetTrainById() throws Exception {
		...
		mockMvc.perform(get("/train/find/10").contentType(MediaType.APPLICATION_JSON).content(asJsonString(train)))
				.andDo(print());
	...
	public void testUpdateTrain() throws Exception {
		...
		mockMvc.perform(put("/train/update").contentType(MediaType.APPLICATION_JSON).content(asJsonString(train)))
				.andExpect(status().isOk());
	...
	public void testDeleteTrainById() throws Exception {
		...
		mockMvc.perform(delete("/train/delete/10").contentType(MediaType.APPLICATION_JSON).content(asJsonString(train)))
				.andExpect(status().isOk());
	...
	public void testGetTrainByName() throws Exception {
		...
		mockMvc.perform(
				get("/train/byname/double-decker").contentType(MediaType.APPLICATION_JSON).content(asJsonString(train)))
				.andDo(print());
