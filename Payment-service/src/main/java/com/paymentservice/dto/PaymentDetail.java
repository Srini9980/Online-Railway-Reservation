...
public class PaymentDetail {
	...
	public PaymentDetail(String merchantId, String merchantKey, String channelId, String website, String industryTypeId,
	...
	public String toString() {
		return "PaymentDetail [merchantId=" + merchantId + ", merchantKey=" + merchantKey + ", channelId=" + channelId
